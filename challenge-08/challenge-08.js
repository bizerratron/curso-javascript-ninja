...
*/
console.log("A soma de " +num_01+" e "+num_02+" é igual a "+sum(num_01, num_02)+".");
/*
...
*/
console.log("The function "+showName.name+" return "+showName());
...
*/
  var calculator = function calculator(operator) {
    return function calculator(param, param2) {
        switch (operator) {
            case "+":
                return "Result of operation: " + param + "+" + param2 + " = " + (param + param2);
                break;
            case "-":
                return "Result of operation: " + param + "-" + param2 + " = " + (param - param2);
                break;
