...
*/
var array = ['Alquimista', 3, true, 'Espada', 'Carro', 7];
...
*/
var arrayInterno = ['Pederastra', false, 2];

console.log(addItem(arrayInterno));
...
*/
console.log("O primeiro array tem "+array[6].length+" itens.");
